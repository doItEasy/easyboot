package com.github.doiteasy.easyboot.plus.dlock.redisson;

import com.github.doiteasy.easyboot.plus.dlock.redisson.strategy.RedisConnectionType;
import com.github.doiteasy.easyboot.plus.dlock.redisson.config.RedissonConfigContext;
import com.github.doiteasy.easyboot.plus.dlock.redisson.config.RedissonProperties;
import com.github.doiteasy.easyboot.plus.dlock.redisson.strategy.ClusterRedissonStrategy;
import com.github.doiteasy.easyboot.plus.dlock.redisson.strategy.MasterslaveRedissonStrategy;
import com.github.doiteasy.easyboot.plus.dlock.redisson.strategy.SentinelRedissonStrategy;
import com.github.doiteasy.easyboot.plus.dlock.redisson.strategy.StandaloneRedissonStrategy;
    ...
    static class RedissonConfigFactory {
        ...
        Config createConfig(RedissonProperties redissonProperties) {
            ...
            if (connectionType.equals(RedisConnectionType.STANDALONE.getConnection_type())) {
                redissonConfigContext = new RedissonConfigContext(new StandaloneRedissonStrategy());
            } else if (connectionType.equals(RedisConnectionType.SENTINEL.getConnection_type())) {
                redissonConfigContext = new RedissonConfigContext(new SentinelRedissonStrategy());
            } else if (connectionType.equals(RedisConnectionType.CLUSTER.getConnection_type())) {
                redissonConfigContext = new RedissonConfigContext(new ClusterRedissonStrategy());
            } else if (connectionType.equals(RedisConnectionType.MASTERSLAVE.getConnection_type())) {
                redissonConfigContext = new RedissonConfigContext(new MasterslaveRedissonStrategy());
            } else {
